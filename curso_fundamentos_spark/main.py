...
print('\nEngenharia de Dados Academy - Script 01 - Distinct:\n')

# Cria uma sessão Spark com um nome específico para a aplicação
spark = SparkSession.builder.appName('EDA-Script').getOrCreate()
...
print(
    'Distinct Count da Tabela Abaixo Removendo Duplicatas: '
    + str(df2.count())
    + '\n'
)
...
print(
    'Distinct Count da Tabela Abaixo Removendo Duplicatas em Duas Colunas Apenas: '
    + str(dropDisDF.count())
    + '\n'
)
